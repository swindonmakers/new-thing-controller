...
void printTitle_updated(String, bool);     // prints message just below top of colour lcd in medium font (1 line) (12 char max) - bool for updating screen (off when multiple msgs to reduce lag)
void printHeadline(String);               // prints message just below top of colour lcd in medium font (1 line) (12 char max)
void printHeadline_updated(String, bool); // prints message just below top of colour lcd in medium font (1 line) (12 char max) - bool for updating screen (off when multiple msgs to reduce lag)
void printBody(String);                   // prints message in smallest text in a scrolling text format (10 lines) (20 char max)
void printBody_updated(String, bool);     // prints message in smallest text in a scrolling text format (10 lines) (20 char max) - bool for updating screen (off when multiple msgs to reduce lag
...
void printTitle(String newMsg = ""){printTitle_updated(newMsg,true);}

void printTitle_updated(String newMsg = "", bool update = true)
{
    titleMsg = newMsg;
    if (serial_enabled)
...
void printHeadline(String newMsg = ""){printHeadline_updated(newMsg,true);}

void printHeadline_updated(String newMsg = "", bool update = true)
{
    headlineMsg = newMsg;
    if (serial_enabled)
        Serial.println(newMsg);
...
void printBody(String newMsg = ""){printBody_updated(newMsg,true);}

void printBody_updated(String newMsg = "", bool update = true)
{
...
String ParseMsgErrorJson(String json){
  if (json == "") return "";
